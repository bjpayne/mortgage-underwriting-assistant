...
missing_interest_rates = dataset['rate_of_interest'].isna().sum()

if missing_interest_rates != 0:
...
dataset['interest_rate_spread'].unique()
...
dataset['term'].isna().sum()

print(dataset[dataset['status'] == 1]['term'].value_counts())
print(dataset[dataset['status'] == 1]['term'].isna().sum())

print(dataset[dataset['status'] == 0]['term'].value_counts())
print(dataset[dataset['status'] == 0]['term'].isna().sum())
...
missing_terms = dataset['term'].isna().sum()

if missing_terms != 0:
  raise ValueError("Term cannot be NaN")
...
print(dataset[dataset['status'] == 0]['property_value'].describe())
print(dataset[dataset['status'] == 1]['property_value'].describe())

print(dataset[dataset['status'] == 0]['property_value'].mode())
print(dataset[dataset['status'] == 1]['property_value'].mode())
...
missing_property_values = dataset['property_value'].isna().sum()

if missing_property_values != 0:
  raise ValueError("Property value cannot be NaN")
...
print(dataset[dataset['status'] == 0]['income'].describe())
print(dataset[dataset['status'] == 1]['income'].describe())

print(dataset[dataset['status'] == 0]['income'].mode())
print(dataset[dataset['status'] == 1]['income'].mode())
...
"""Impute NaNs with the median of each status"""
...
missing_incomes = dataset['income'].isna().sum()

if missing_incomes != 0:
...
"""LTV cannot be NaN...impute to loan_amount / property_value"""

dataset.loc[dataset['ltv'].isna(), 'ltv'] = ((dataset['loan_amount'] / dataset['property_value']) * 100)

dataset['ltv'].unique()

missing_ltvs = dataset['ltv'].isna().sum()

if missing_ltvs != 0:
  raise ValueError('LTV cannot be NaN')
...
"""Feature vector is continous so impute the median of each status"""
...
missing_dtis = dataset['dtir1'].isna().sum()

if missing_dtis != 0:
  raise ValueError('DTI cannot be NaN')
